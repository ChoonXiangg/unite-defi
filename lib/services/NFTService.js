...
class NFTService {
  constructor(evmProvider) {
    ...
    this.deployedContract = {
      ...
      deployedAt: "2025-07-28T16:27:10.469Z",
   ...
   * Mint a single NFT
   */
  async mintNFT(walletData, contractAddress, mintParams, network = 'arbitrumSepolia') {
    try {
   ...
   * Batch mint NFTs
   */
  async batchMintNFTs(walletData, contractAddress, batchMintParams, network = 'arbitrumSepolia') {
    try {
